...
def main():
    ...
    local_file = r"C:\Users\geraldo.borges\CascadeProjects\SAG\poc-web\sag-poc-azure.tar.gz"
    remote_path = "/opt/sag-poc-azure.tar.gz"
    ...
    commands = [
        ...
        "cd /opt/sag-poc && tar -xzvf /opt/sag-poc-azure.tar.gz",
